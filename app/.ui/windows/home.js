...
export class HomeWindow extends Window {
    template() {
        return `
            <div class="greeting">
    ...
    bindEvents() {
        const filterOptions = this.$$(".filter-option");
        ...
        const sortDateButton = this.$(".sort-date");
        const sortArrow = this.$(".sort-arrow");
        ...
        sortDateButton.addEventListener("click", () => {
            ...
            console.log(ascending ? "Oldest first" : "Newest first");
        });
    }
}

WindowManager.register("home", HomeWindow, { title: "Home" });
