...
export class GamesWindow extends Window {
    template() {
        return `
    ...
    bindEvents() {
        const filters = this.$$(".game-filter");
        const gameCards = this.$$(".game-card");
        ...
        const playButtons = this.$$(".play-btn");
...
WindowManager.register("games", GamesWindow, { title: "Games" });
